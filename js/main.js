(function ($) {
    ...
    /*Mainmenu affix after scolling home page
    =================*/
    $('.mainmenu-area').affix({
        offset: {
          top: function() { return $('#home-page').height(); }
        }
    });
    ...
    $(function () {
        $(window).scroll(function () {
            ...
            if ($(this).scrollTop() > 0.9*$('#home-page').height() ){
                $('.mainmenu-area').fadeIn();
            } else {
                $('.mainmenu-area').fadeOut();
            }
        });
    });
