...
$(document).ready(function(){
	...
	drawGraphAboutMe();
	drawHistory();
	d3.json("assets/old/files/skills.json", function(json) {
...
function drawHistory(){
	...
	d3.json("assets/old/files/historyData.json", function(error, json) {
		historyData = json;
		update();
	});
		...
		$.each(historyData, function(i,d) {
			...
			if(d.group=="image"){
				...
				var image = svg.append("svg:image")
					.attr("xlink:href", "/assets/images/history/"+d.name+".png")
					.attr("x", x)
					.attr("y", y)
...
function drawGraphAboutMe(){
    ...
    d3.json("assets/old/files/aboutMe.json", function(json){
...
function drawGraphSkills(nodes){
	...
	var image = svg.append("svg:g")
			...
			.attr("xlink:href", function(d) { return "/assets/images/skills/"+d.name+".png"; })
